...
export CUDA_VISIBLE_DEVICES=3;python extract_tfrecords_with_audio.py --input_videos_csv ${INPUT_CSV}  --output_tfrecords_file $OUTPUT   --wav_tmp $WAV_TMP

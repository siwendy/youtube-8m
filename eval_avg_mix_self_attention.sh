...
train_dir="trained_model/MixSelfAttentionModel_avg"
parameters="--self_attention_n_head=8 --self_attention_n_layer=2 --self_attention_filter_size=2 --self_attention_cluster_dropouss0.5 --self_attention_ff_dropout=0.5 --self_attention_hidden_size=512"

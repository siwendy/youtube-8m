...
parameters="--groups=8 --nextvlad_cluster_size=128 --nextvlad_hidden_size=2048 \
            --expansion=2 --gating_reduction=8 --drop_rate=0.5 --enable_gate=False"

train_dir=trained_model/nextvlad_8g_5l2_5drop_128k_2048_2x80_logistic_no_gate
...
python train.py ${parameters} --model=${model_name}  --num_readers=8 --learning_rate_decay_examples 2000000 \
                ...
                --learning_rate_decay=0.8 --l2_penalty=1e-5 --max_step=700000 --num_gpu=${num_gpu} > log.${model_name}.no_gate 2>&1 &
